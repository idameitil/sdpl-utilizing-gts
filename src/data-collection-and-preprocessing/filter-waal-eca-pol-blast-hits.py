...
blast_threshold = float(sys.argv[4])
...
accessions_include = df.loc[df.evalue < blast_threshold, 'acc']

outfile_name = f"data/{protein_family}/blast/unique-hits-short-headers-{blast_threshold}-filtered.fasta"
