...
### O-POL ###
retaining = ['X606', 'X608', 'X610', 'X611', 'X612', 'X633']
inverting = ['X605', 'X607', 'X609', 'X613', 'X614', 'X617', 'X632', 'X631']

inv_group1 = ["615_i_7TPG_O-Lig", "571_i_AF-6BAR", "614_i_AAM27615.1", "609_i_CAI34254.1", "607_i_CAI34124.1", "613_i_CAI34369.1", "605_i_BAQ02088.1", "632_i_CAI33412.1"]
inv_group2 = ["617_i_AHB32861.1", "631_i_BAQ01641.1"]
ret_group1 = ["612_r_ADC54950.1", "611_r_AAA97573.1", "606_r_AAT77177.1", "610_r_AHB32411.1", "633_r_ABG81806.1"]
...
acc2family = {'AAM27615.1': 'X614', 'CAI34254.1': 'X609', 'CAI34124.1': 'X607', 'CAI34369.1': 'X613',
              ...
              'ABG81806.1': 'X633', 'BAQ01641.1': 'X631', 'CAI33412.1': 'X632'}
...
for object_name in object_names:
    if object_name in inv_group1:
        align_object = "607_i_CAI34124.1"
    elif object_name in inv_group2:
        align_object = "617_i_AHB32861.1"
