...
class SSNClusterData:
    ...
    def load_cluster_data(self, cluster_id):
        ...
        if self.calculate_conserved:
            cluster_info['conserved_residues'] = get_conserved_residues(fasta_dict, include_aliphatic=False)
    ...
    def load_supercluster_data(self, supercluster_id):
        ...
        if self.calculate_conserved_superclusters:
            supercluster_info['conserved_residues'] = get_conserved_residues(fasta_dict, include_aliphatic=False)
