...
The residues that we want to show on the figure, are written in `data/compare-architectures/conserved_manual.json`. This is turned into a js file (`data/compare-architectures/conserved_manual.js`) in the above script. The offsets are added manually to `data/compare-architectures/conserved_manual_offsets.js`. This is the data file read by the html script.
