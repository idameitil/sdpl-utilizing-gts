...
select cons_ACA24821.1, resi 54 and 1_ACA24821.1 or resi 58 and 1_ACA24821.1 or resi 134 and 1_ACA24821.1 or resi 168 and 1_ACA24821.1 or resi 224 and 1_ACA24821.1 or resi 290 and 1_ACA24821.1
...
cealign 1_ACA24821.1, 1_ACA24852.1
...
label n. CA and resi 229 and 1_ACA24852.1, "%s-%s" % (resn, resi)
label n. CA and resi 299 and 1_ACA24852.1, "%s-%s" % (resn, resi)
select cons_ACA24852.1, resi 54 and 1_ACA24852.1 or resi 58 and 1_ACA24852.1 or resi 134 and 1_ACA24852.1 or resi 168 and 1_ACA24852.1 or resi 229 and 1_ACA24852.1 or resi 299 and 1_ACA24852.1
...
cealign 1_ACA24821.1, 1_WP_024244058.1
...
cealign 1_ACA24821.1, 1_ACV67297.1
...
load data/wzy/alphafold/AIG62747.1/ranked_0.pdb, 2_AIG62747.1
color 0xeeeeee, 2_AIG62747.1
cealign 2_CAI33309.1, 2_AIG62747.1

label n. CA and resi 134 and 2_AIG62747.1, "%s-%s" % (resn, resi)
label n. CA and resi 250 and 2_AIG62747.1, "%s-%s" % (resn, resi)
label n. CA and resi 280 and 2_AIG62747.1, "%s-%s" % (resn, resi)
select cons_AIG62747.1, resi 134 and 2_AIG62747.1 or resi 250 and 2_AIG62747.1 or resi 280 and 2_AIG62747.1
...
cealign 7_BAQ00795.1, 7_ACA24754.1
...
cealign 7_BAQ00795.1, 7_BAQ02088.1
...
load data/wzy/alphafold/BAQ00653.1/ranked_0.pdb, 3_BAQ00653.1
color 0xeeeeee, 3_BAQ00653.1
cealign 7tpg, 3_BAQ00653.1

label n. CA and resi 246 and 3_BAQ00653.1, "%s-%s" % (resn, resi)
label n. CA and resi 301 and 3_BAQ00653.1, "%s-%s" % (resn, resi)
select cons_BAQ00653.1, resi 246 and 3_BAQ00653.1 or resi 301 and 3_BAQ00653.1
show licorice, cons_BAQ00653.1
color atomic, cons_BAQ00653.1



load data/wzy/alphafold/ADC54950.1/ranked_0.pdb, 3_ADC54950.1
color 0xeeeeee, 3_ADC54950.1
cealign 3_BAQ00653.1, 3_ADC54950.1

label n. CA and resi 249 and 3_ADC54950.1, "%s-%s" % (resn, resi)
label n. CA and resi 305 and 3_ADC54950.1, "%s-%s" % (resn, resi)
select cons_ADC54950.1, resi 249 and 3_ADC54950.1 or resi 305 and 3_ADC54950.1
show licorice, cons_ADC54950.1
color atomic, cons_ADC54950.1



load data/wzy/alphafold/CBN82200.1/ranked_0.pdb, 10_CBN82200.1
color 0xeeeeee, 10_CBN82200.1
cealign 7tpg, 10_CBN82200.1

label n. CA and resi 211 and 10_CBN82200.1, "%s-%s" % (resn, resi)
label n. CA and resi 270 and 10_CBN82200.1, "%s-%s" % (resn, resi)
select cons_CBN82200.1, resi 211 and 10_CBN82200.1 or resi 270 and 10_CBN82200.1
...
color 0xeeeeee, 10_AAT77177.1
cealign 10_CBN82200.1, 10_AAT77177.1

label n. CA and resi 226 and 10_AAT77177.1, "%s-%s" % (resn, resi)
label n. CA and resi 284 and 10_AAT77177.1, "%s-%s" % (resn, resi)
select cons_AAT77177.1, resi 226 and 10_AAT77177.1 or resi 284 and 10_AAT77177.1
show licorice, cons_AAT77177.1
color atomic, cons_AAT77177.1



load data/wzy/alphafold/CAI34124.1/ranked_0.pdb, 30_CAI34124.1
color 0xeeeeee, 30_CAI34124.1
cealign 7tpg, 30_CAI34124.1

label n. CA and resi 267 and 30_CAI34124.1, "%s-%s" % (resn, resi)
label n. CA and resi 301 and 30_CAI34124.1, "%s-%s" % (resn, resi)
label n. CA and resi 304 and 30_CAI34124.1, "%s-%s" % (resn, resi)
label n. CA and resi 325 and 30_CAI34124.1, "%s-%s" % (resn, resi)
select cons_CAI34124.1, resi 267 and 30_CAI34124.1 or resi 301 and 30_CAI34124.1 or resi 304 and 30_CAI34124.1 or resi 325 and 30_CAI34124.1
show licorice, cons_CAI34124.1
color atomic, cons_CAI34124.1



load data/wzy/alphafold/AHB32411.1/ranked_0.pdb, 31_AHB32411.1
color 0xeeeeee, 31_AHB32411.1
cealign 7tpg, 31_AHB32411.1

label n. CA and resi 162 and 31_AHB32411.1, "%s-%s" % (resn, resi)
label n. CA and resi 207 and 31_AHB32411.1, "%s-%s" % (resn, resi)
label n. CA and resi 242 and 31_AHB32411.1, "%s-%s" % (resn, resi)
label n. CA and resi 244 and 31_AHB32411.1, "%s-%s" % (resn, resi)
label n. CA and resi 251 and 31_AHB32411.1, "%s-%s" % (resn, resi)
select cons_AHB32411.1, resi 162 and 31_AHB32411.1 or resi 207 and 31_AHB32411.1 or resi 242 and 31_AHB32411.1 or resi 244 and 31_AHB32411.1 or resi 251 and 31_AHB32411.1
show licorice, cons_AHB32411.1
color atomic, cons_AHB32411.1



load data/wzy/alphafold/CAI34254.1/ranked_0.pdb, 32_CAI34254.1
color 0xeeeeee, 32_CAI34254.1
cealign 7tpg, 32_CAI34254.1

label n. CA and resi 182 and 32_CAI34254.1, "%s-%s" % (resn, resi)
label n. CA and resi 183 and 32_CAI34254.1, "%s-%s" % (resn, resi)
label n. CA and resi 189 and 32_CAI34254.1, "%s-%s" % (resn, resi)
label n. CA and resi 277 and 32_CAI34254.1, "%s-%s" % (resn, resi)
select cons_CAI34254.1, resi 182 and 32_CAI34254.1 or resi 183 and 32_CAI34254.1 or resi 189 and 32_CAI34254.1 or resi 277 and 32_CAI34254.1
show licorice, cons_CAI34254.1
color atomic, cons_CAI34254.1



load data/wzy/alphafold/CAI34198.1/ranked_0.pdb, 32_CAI34198.1
color 0xeeeeee, 32_CAI34198.1
cealign 32_CAI34254.1, 32_CAI34198.1

label n. CA and resi 182 and 32_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 183 and 32_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 189 and 32_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 278 and 32_CAI34198.1, "%s-%s" % (resn, resi)
select cons_CAI34198.1, resi 182 and 32_CAI34198.1 or resi 183 and 32_CAI34198.1 or resi 189 and 32_CAI34198.1 or resi 278 and 32_CAI34198.1
show licorice, cons_CAI34198.1
color atomic, cons_CAI34198.1



load data/wzy/alphafold/CAI34217.1/ranked_0.pdb, 32_CAI34217.1
color 0xeeeeee, 32_CAI34217.1
cealign 32_CAI34254.1, 32_CAI34217.1

label n. CA and resi 186 and 32_CAI34217.1, "%s-%s" % (resn, resi)
label n. CA and resi 187 and 32_CAI34217.1, "%s-%s" % (resn, resi)
label n. CA and resi 193 and 32_CAI34217.1, "%s-%s" % (resn, resi)
label n. CA and resi 281 and 32_CAI34217.1, "%s-%s" % (resn, resi)
select cons_CAI34217.1, resi 186 and 32_CAI34217.1 or resi 187 and 32_CAI34217.1 or resi 193 and 32_CAI34217.1 or resi 281 and 32_CAI34217.1
show licorice, cons_CAI34217.1
color atomic, cons_CAI34217.1



load data/wzy/alphafold/CAI33412.1/ranked_0.pdb, 11_CAI33412.1
color 0xeeeeee, 11_CAI33412.1
cealign 7tpg, 11_CAI33412.1

label n. CA and resi 98 and 11_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 149 and 11_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 162 and 11_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 205 and 11_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 207 and 11_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 281 and 11_CAI33412.1, "%s-%s" % (resn, resi)
select cons_CAI33412.1, resi 98 and 11_CAI33412.1 or resi 149 and 11_CAI33412.1 or resi 162 and 11_CAI33412.1 or resi 205 and 11_CAI33412.1 or resi 207 and 11_CAI33412.1 or resi 281 and 11_CAI33412.1
show licorice, cons_CAI33412.1
color atomic, cons_CAI33412.1



load data/wzy/alphafold/CAB63298.1/ranked_0.pdb, 14_CAB63298.1
color 0xeeeeee, 14_CAB63298.1
cealign 7tpg, 14_CAB63298.1

label n. CA and resi 214 and 14_CAB63298.1, "%s-%s" % (resn, resi)
label n. CA and resi 218 and 14_CAB63298.1, "%s-%s" % (resn, resi)
label n. CA and resi 239 and 14_CAB63298.1, "%s-%s" % (resn, resi)
select cons_CAB63298.1, resi 214 and 14_CAB63298.1 or resi 218 and 14_CAB63298.1 or resi 239 and 14_CAB63298.1
show licorice, cons_CAB63298.1
color atomic, cons_CAB63298.1



load data/wzy/alphafold/BAQ02224.1/ranked_0.pdb, 14_BAQ02224.1
color 0xeeeeee, 14_BAQ02224.1
cealign 14_CAB63298.1, 14_BAQ02224.1

label n. CA and resi 217 and 14_BAQ02224.1, "%s-%s" % (resn, resi)
label n. CA and resi 221 and 14_BAQ02224.1, "%s-%s" % (resn, resi)
label n. CA and resi 255 and 14_BAQ02224.1, "%s-%s" % (resn, resi)
select cons_BAQ02224.1, resi 217 and 14_BAQ02224.1 or resi 221 and 14_BAQ02224.1 or resi 255 and 14_BAQ02224.1
show licorice, cons_BAQ02224.1
color atomic, cons_BAQ02224.1



load data/wzy/alphafold/AFC91472.1/ranked_0.pdb, 14_AFC91472.1
color 0xeeeeee, 14_AFC91472.1
cealign 14_CAB63298.1, 14_AFC91472.1

label n. CA and resi 204 and 14_AFC91472.1, "%s-%s" % (resn, resi)
label n. CA and resi 208 and 14_AFC91472.1, "%s-%s" % (resn, resi)
label n. CA and resi 239 and 14_AFC91472.1, "%s-%s" % (resn, resi)
select cons_AFC91472.1, resi 204 and 14_AFC91472.1 or resi 208 and 14_AFC91472.1 or resi 239 and 14_AFC91472.1
show licorice, cons_AFC91472.1
color atomic, cons_AFC91472.1



load data/wzy/alphafold/BAQ01843.1/ranked_0.pdb, 14_BAQ01843.1
color 0xeeeeee, 14_BAQ01843.1
cealign 14_CAB63298.1, 14_BAQ01843.1

label n. CA and resi 223 and 14_BAQ01843.1, "%s-%s" % (resn, resi)
label n. CA and resi 227 and 14_BAQ01843.1, "%s-%s" % (resn, resi)
label n. CA and resi 246 and 14_BAQ01843.1, "%s-%s" % (resn, resi)
select cons_BAQ01843.1, resi 223 and 14_BAQ01843.1 or resi 227 and 14_BAQ01843.1 or resi 246 and 14_BAQ01843.1
show licorice, cons_BAQ01843.1
color atomic, cons_BAQ01843.1



load data/wzy/alphafold/ABG81806.1/ranked_0.pdb, 14_ABG81806.1
color 0xeeeeee, 14_ABG81806.1
cealign 14_CAB63298.1, 14_ABG81806.1

label n. CA and resi 217 and 14_ABG81806.1, "%s-%s" % (resn, resi)
label n. CA and resi 221 and 14_ABG81806.1, "%s-%s" % (resn, resi)
label n. CA and resi 255 and 14_ABG81806.1, "%s-%s" % (resn, resi)
select cons_ABG81806.1, resi 217 and 14_ABG81806.1 or resi 221 and 14_ABG81806.1 or resi 255 and 14_ABG81806.1
show licorice, cons_ABG81806.1
color atomic, cons_ABG81806.1



load data/wzy/alphafold/AHB32490.1/ranked_0.pdb, 12_AHB32490.1
color 0xeeeeee, 12_AHB32490.1
cealign 7tpg, 12_AHB32490.1

label n. CA and resi 175 and 12_AHB32490.1, "%s-%s" % (resn, resi)
label n. CA and resi 238 and 12_AHB32490.1, "%s-%s" % (resn, resi)
label n. CA and resi 429 and 12_AHB32490.1, "%s-%s" % (resn, resi)
select cons_AHB32490.1, resi 175 and 12_AHB32490.1 or resi 238 and 12_AHB32490.1 or resi 429 and 12_AHB32490.1
show licorice, cons_AHB32490.1
color atomic, cons_AHB32490.1



load data/wzy/alphafold/AAM27615.1/ranked_0.pdb, 13_AAM27615.1
color 0xeeeeee, 13_AAM27615.1
cealign 7tpg, 13_AAM27615.1

label n. CA and resi 188 and 13_AAM27615.1, "%s-%s" % (resn, resi)
label n. CA and resi 260 and 13_AAM27615.1, "%s-%s" % (resn, resi)
label n. CA and resi 263 and 13_AAM27615.1, "%s-%s" % (resn, resi)
label n. CA and resi 289 and 13_AAM27615.1, "%s-%s" % (resn, resi)
label n. CA and resi 298 and 13_AAM27615.1, "%s-%s" % (resn, resi)
label n. CA and resi 357 and 13_AAM27615.1, "%s-%s" % (resn, resi)
select cons_AAM27615.1, resi 188 and 13_AAM27615.1 or resi 260 and 13_AAM27615.1 or resi 263 and 13_AAM27615.1 or resi 289 and 13_AAM27615.1 or resi 298 and 13_AAM27615.1 or resi 357 and 13_AAM27615.1
