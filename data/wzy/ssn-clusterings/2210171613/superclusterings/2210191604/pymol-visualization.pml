...
load data/wzy/alphafold/CAI34124.1/ranked_0.pdb, 10_CAI34124.1
color teal, 10_CAI34124.1
...
load data/wzy/alphafold/AHB32411.1/ranked_0.pdb, 12_AHB32411.1
color teal, 12_AHB32411.1
cealign 7tpg, 12_AHB32411.1

label n. CA and resi 162 and 12_AHB32411.1, "%s-%s" % (resn, resi)
label n. CA and resi 207 and 12_AHB32411.1, "%s-%s" % (resn, resi)
label n. CA and resi 242 and 12_AHB32411.1, "%s-%s" % (resn, resi)
label n. CA and resi 244 and 12_AHB32411.1, "%s-%s" % (resn, resi)
label n. CA and resi 251 and 12_AHB32411.1, "%s-%s" % (resn, resi)
select cons_AHB32411.1, resi 162 and 12_AHB32411.1 or resi 207 and 12_AHB32411.1 or resi 242 and 12_AHB32411.1 or resi 244 and 12_AHB32411.1 or resi 251 and 12_AHB32411.1
show licorice, cons_AHB32411.1
color atomic, cons_AHB32411.1



load data/wzy/alphafold/BAQ00795.1/ranked_0.pdb, 13_BAQ00795.1
...
label n. CA and resi 159 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 160 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
...
label n. CA and resi 222 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 226 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 232 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 258 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 261 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 265 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 276 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 297 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 300 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 307 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 308 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 312 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 313 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
label n. CA and resi 317 and 13_BAQ00795.1, "%s-%s" % (resn, resi)
...
load data/wzy/alphafold/CAI34198.1/ranked_0.pdb, 15_CAI34198.1
color teal, 15_CAI34198.1
cealign 7tpg, 15_CAI34198.1

label n. CA and resi 182 and 15_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 183 and 15_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 189 and 15_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 278 and 15_CAI34198.1, "%s-%s" % (resn, resi)
select cons_CAI34198.1, resi 182 and 15_CAI34198.1 or resi 183 and 15_CAI34198.1 or resi 189 and 15_CAI34198.1 or resi 278 and 15_CAI34198.1
...
label n. CA and resi 187 and 15_CAI34217.1, "%s-%s" % (resn, resi)
label n. CA and resi 193 and 15_CAI34217.1, "%s-%s" % (resn, resi)
label n. CA and resi 281 and 15_CAI34217.1, "%s-%s" % (resn, resi)
select cons_CAI34217.1, resi 186 and 15_CAI34217.1 or resi 187 and 15_CAI34217.1 or resi 193 and 15_CAI34217.1 or resi 281 and 15_CAI34217.1
