...
color orange, 1_ABK27355.1
cealign 1_AAK64372.1, 1_ABK27355.1
...
color green, 1_AAS98031.1
cealign 1_AAK64372.1, 1_AAS98031.1
...
color br6, 1_ABI98976.1
cealign 1_AAK64372.1, 1_ABI98976.1
...
color red, 1_ABB29906.1
cealign 1_AAK64372.1, 1_ABB29906.1
...
color teal, 4_CAI34369.1
cealign 7tpg, 4_CAI34369.1
...
color orange, 4_CAI33309.1
cealign 4_CAI34369.1, 4_CAI33309.1
...
color green, 4_AIG62747.1
cealign 4_CAI34369.1, 4_AIG62747.1
...
color br6, 4_BAQ00957.1
cealign 4_CAI34369.1, 4_BAQ00957.1
...
color orange, 2_AHB32411.1
cealign 2_AAZ85718.1, 2_AHB32411.1
...
color red, 2_BAQ01516.1
cealign 2_AAZ85718.1, 2_BAQ01516.1
...
color teal, 3_ADI43263.1
cealign 7tpg, 3_ADI43263.1
...
load data/wzy/alphafold/AAM27615.1/ranked_0.pdb, 3_AAM27615.1
color orange, 3_AAM27615.1
cealign 3_ADI43263.1, 3_AAM27615.1
...
color green, 3_CAI33817.1
cealign 3_ADI43263.1, 3_CAI33817.1
...
cealign 3_ADI43263.1, 3_ADR74237.1
...
load data/wzy/alphafold/ABI98986.1/ranked_0.pdb, 3_ABI98986.1
color red, 3_ABI98986.1
cealign 3_ADI43263.1, 3_ABI98986.1

select cons_ABI98986
show licorice, cons_ABI98986.1
color atomic, cons_ABI98986.1



load data/wzy/alphafold/AAC45857.1/ranked_0.pdb, 10_AAC45857.1
color teal, 10_AAC45857.1
cealign 7tpg, 10_AAC45857.1
...
color orange, 10_AAA97573.1
cealign 10_AAC45857.1, 10_AAA97573.1
...
cealign 10_AAC45857.1, 10_CDF66396.1
...
load data/wzy/alphafold/BAQ01659.1/ranked_0.pdb, 7_BAQ01659.1
color green, 7_BAQ01659.1
cealign 7_ACA24754.1, 7_BAQ01659.1

label n. CA and resi 211 and 7_BAQ01659.1, "%s-%s" % (resn, resi)
label n. CA and resi 279 and 7_BAQ01659.1, "%s-%s" % (resn, resi)
label n. CA and resi 315 and 7_BAQ01659.1, "%s-%s" % (resn, resi)
label n. CA and resi 367 and 7_BAQ01659.1, "%s-%s" % (resn, resi)
select cons_BAQ01659.1, resi 211 and 7_BAQ01659.1 or resi 279 and 7_BAQ01659.1 or resi 315 and 7_BAQ01659.1 or resi 367 and 7_BAQ01659.1
...
load data/wzy/alphafold/CAI34124.1/ranked_0.pdb, 26_CAI34124.1
color teal, 26_CAI34124.1
cealign 7tpg, 26_CAI34124.1

label n. CA and resi 267 and 26_CAI34124.1, "%s-%s" % (resn, resi)
label n. CA and resi 301 and 26_CAI34124.1, "%s-%s" % (resn, resi)
label n. CA and resi 304 and 26_CAI34124.1, "%s-%s" % (resn, resi)
label n. CA and resi 325 and 26_CAI34124.1, "%s-%s" % (resn, resi)
select cons_CAI34124.1, resi 267 and 26_CAI34124.1 or resi 301 and 26_CAI34124.1 or resi 304 and 26_CAI34124.1 or resi 325 and 26_CAI34124.1
show licorice, cons_CAI34124.1
color atomic, cons_CAI34124.1



load data/wzy/alphafold/BAQ02224.1/ranked_0.pdb, 6_BAQ02224.1
color teal, 6_BAQ02224.1
cealign 7tpg, 6_BAQ02224.1

label n. CA and resi 221 and 6_BAQ02224.1, "%s-%s" % (resn, resi)
label n. CA and resi 255 and 6_BAQ02224.1, "%s-%s" % (resn, resi)
select cons_BAQ02224.1, resi 221 and 6_BAQ02224.1 or resi 255 and 6_BAQ02224.1
show licorice, cons_BAQ02224.1
color atomic, cons_BAQ02224.1



load data/wzy/alphafold/BAQ01843.1/ranked_0.pdb, 6_BAQ01843.1
color orange, 6_BAQ01843.1
cealign 6_BAQ02224.1, 6_BAQ01843.1

label n. CA and resi 227 and 6_BAQ01843.1, "%s-%s" % (resn, resi)
label n. CA and resi 246 and 6_BAQ01843.1, "%s-%s" % (resn, resi)
select cons_BAQ01843.1, resi 227 and 6_BAQ01843.1 or resi 246 and 6_BAQ01843.1
show licorice, cons_BAQ01843.1
color atomic, cons_BAQ01843.1



load data/wzy/alphafold/CAB63298.1/ranked_0.pdb, 6_CAB63298.1
color green, 6_CAB63298.1
cealign 6_BAQ02224.1, 6_CAB63298.1

label n. CA and resi 218 and 6_CAB63298.1, "%s-%s" % (resn, resi)
label n. CA and resi 239 and 6_CAB63298.1, "%s-%s" % (resn, resi)
select cons_CAB63298.1, resi 218 and 6_CAB63298.1 or resi 239 and 6_CAB63298.1
show licorice, cons_CAB63298.1
color atomic, cons_CAB63298.1



load data/wzy/alphafold/AFC91472.1/ranked_0.pdb, 6_AFC91472.1
color br6, 6_AFC91472.1
cealign 6_BAQ02224.1, 6_AFC91472.1

label n. CA and resi 208 and 6_AFC91472.1, "%s-%s" % (resn, resi)
label n. CA and resi 239 and 6_AFC91472.1, "%s-%s" % (resn, resi)
select cons_AFC91472.1, resi 208 and 6_AFC91472.1 or resi 239 and 6_AFC91472.1
show licorice, cons_AFC91472.1
color atomic, cons_AFC91472.1



load data/wzy/alphafold/ABG81806.1/ranked_0.pdb, 6_ABG81806.1
color red, 6_ABG81806.1
cealign 6_BAQ02224.1, 6_ABG81806.1

label n. CA and resi 221 and 6_ABG81806.1, "%s-%s" % (resn, resi)
label n. CA and resi 255 and 6_ABG81806.1, "%s-%s" % (resn, resi)
select cons_ABG81806.1, resi 221 and 6_ABG81806.1 or resi 255 and 6_ABG81806.1
show licorice, cons_ABG81806.1
color atomic, cons_ABG81806.1



load data/wzy/alphafold/CAI34198.1/ranked_0.pdb, 27_CAI34198.1
color teal, 27_CAI34198.1
cealign 7tpg, 27_CAI34198.1

label n. CA and resi 182 and 27_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 183 and 27_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 189 and 27_CAI34198.1, "%s-%s" % (resn, resi)
label n. CA and resi 278 and 27_CAI34198.1, "%s-%s" % (resn, resi)
select cons_CAI34198.1, resi 182 and 27_CAI34198.1 or resi 183 and 27_CAI34198.1 or resi 189 and 27_CAI34198.1 or resi 278 and 27_CAI34198.1
show licorice, cons_CAI34198.1
color atomic, cons_CAI34198.1



load data/wzy/alphafold/CAI34254.1/ranked_0.pdb, 27_CAI34254.1
color orange, 27_CAI34254.1
cealign 27_CAI34198.1, 27_CAI34254.1

label n. CA and resi 182 and 27_CAI34254.1, "%s-%s" % (resn, resi)
label n. CA and resi 183 and 27_CAI34254.1, "%s-%s" % (resn, resi)
label n. CA and resi 189 and 27_CAI34254.1, "%s-%s" % (resn, resi)
label n. CA and resi 277 and 27_CAI34254.1, "%s-%s" % (resn, resi)
select cons_CAI34254.1, resi 182 and 27_CAI34254.1 or resi 183 and 27_CAI34254.1 or resi 189 and 27_CAI34254.1 or resi 277 and 27_CAI34254.1
show licorice, cons_CAI34254.1
color atomic, cons_CAI34254.1



load data/wzy/alphafold/CAI34217.1/ranked_0.pdb, 27_CAI34217.1
color green, 27_CAI34217.1
cealign 27_CAI34198.1, 27_CAI34217.1

label n. CA and resi 186 and 27_CAI34217.1, "%s-%s" % (resn, resi)
label n. CA and resi 187 and 27_CAI34217.1, "%s-%s" % (resn, resi)
label n. CA and resi 193 and 27_CAI34217.1, "%s-%s" % (resn, resi)
label n. CA and resi 281 and 27_CAI34217.1, "%s-%s" % (resn, resi)
select cons_CAI34217.1, resi 186 and 27_CAI34217.1 or resi 187 and 27_CAI34217.1 or resi 193 and 27_CAI34217.1 or resi 281 and 27_CAI34217.1
...
label n. CA and resi 98 and 14_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 149 and 14_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 162 and 14_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 205 and 14_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 207 and 14_CAI33412.1, "%s-%s" % (resn, resi)
label n. CA and resi 281 and 14_CAI33412.1, "%s-%s" % (resn, resi)
select cons_CAI33412.1, resi 98 and 14_CAI33412.1 or resi 149 and 14_CAI33412.1 or resi 162 and 14_CAI33412.1 or resi 205 and 14_CAI33412.1 or resi 207 and 14_CAI33412.1 or resi 281 and 14_CAI33412.1
show licorice, cons_CAI33412.1
color atomic, cons_CAI33412.1



load data/wzy/alphafold/ADI43271.1/ranked_0.pdb, 8_ADI43271.1
color teal, 8_ADI43271.1
cealign 7tpg, 8_ADI43271.1

label n. CA and resi 57 and 8_ADI43271.1, "%s-%s" % (resn, resi)
label n. CA and resi 157 and 8_ADI43271.1, "%s-%s" % (resn, resi)
label n. CA and resi 192 and 8_ADI43271.1, "%s-%s" % (resn, resi)
label n. CA and resi 250 and 8_ADI43271.1, "%s-%s" % (resn, resi)
label n. CA and resi 315 and 8_ADI43271.1, "%s-%s" % (resn, resi)
select cons_ADI43271.1, resi 57 and 8_ADI43271.1 or resi 157 and 8_ADI43271.1 or resi 192 and 8_ADI43271.1 or resi 250 and 8_ADI43271.1 or resi 315 and 8_ADI43271.1
show licorice, cons_ADI43271.1
color atomic, cons_ADI43271.1



load data/wzy/alphafold/ACD37078.1/ranked_0.pdb, 8_ACD37078.1
color orange, 8_ACD37078.1
cealign 8_ADI43271.1, 8_ACD37078.1

label n. CA and resi 61 and 8_ACD37078.1, "%s-%s" % (resn, resi)
label n. CA and resi 152 and 8_ACD37078.1, "%s-%s" % (resn, resi)
label n. CA and resi 187 and 8_ACD37078.1, "%s-%s" % (resn, resi)
label n. CA and resi 255 and 8_ACD37078.1, "%s-%s" % (resn, resi)
label n. CA and resi 324 and 8_ACD37078.1, "%s-%s" % (resn, resi)
select cons_ACD37078.1, resi 61 and 8_ACD37078.1 or resi 152 and 8_ACD37078.1 or resi 187 and 8_ACD37078.1 or resi 255 and 8_ACD37078.1 or resi 324 and 8_ACD37078.1
show licorice, cons_ACD37078.1
color atomic, cons_ACD37078.1



load data/wzy/alphafold/AAD50486.1/ranked_0.pdb, 8_AAD50486.1
color green, 8_AAD50486.1
cealign 8_ADI43271.1, 8_AAD50486.1

label n. CA and resi 56 and 8_AAD50486.1, "%s-%s" % (resn, resi)
label n. CA and resi 151 and 8_AAD50486.1, "%s-%s" % (resn, resi)
label n. CA and resi 185 and 8_AAD50486.1, "%s-%s" % (resn, resi)
label n. CA and resi 252 and 8_AAD50486.1, "%s-%s" % (resn, resi)
label n. CA and resi 318 and 8_AAD50486.1, "%s-%s" % (resn, resi)
select cons_AAD50486.1, resi 56 and 8_AAD50486.1 or resi 151 and 8_AAD50486.1 or resi 185 and 8_AAD50486.1 or resi 252 and 8_AAD50486.1 or resi 318 and 8_AAD50486.1
