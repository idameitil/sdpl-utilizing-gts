...
label n. CA and resi 191 and 615_i_7TPG_O-Lig, "%s-%s" % (resn, resi)
label n. CA and resi 242 and 615_i_7TPG_O-Lig, "%s-%s" % (resn, resi)
label n. CA and resi 261 and 615_i_7TPG_O-Lig, "%s-%s" % (resn, resi)
label n. CA and resi 265 and 615_i_7TPG_O-Lig, "%s-%s" % (resn, resi)
label n. CA and resi 313 and 615_i_7TPG_O-Lig, "%s-%s" % (resn, resi)
...
show licorice, cons_613_i_CAI34369.1
    ...
    label n. CA and resi 133 and 612_r_ADC54950.1, "%s-%s" % (resn, resi)
label n. CA and resi 190 and 612_r_ADC54950.1, "%s-%s" % (resn, resi)
label n. CA and resi 233 and 612_r_ADC54950.1, "%s-%s" % (resn, resi)
...
show licorice, cons_614_i_AAM27615.1
    ...
    label n. CA and resi 165 and 606_r_AAT77177.1, "%s-%s" % (resn, resi)
label n. CA and resi 226 and 606_r_AAT77177.1, "%s-%s" % (resn, resi)
label n. CA and resi 266 and 606_r_AAT77177.1, "%s-%s" % (resn, resi)
label n. CA and resi 284 and 606_r_AAT77177.1, "%s-%s" % (resn, resi)
label n. CA and resi 348 and 606_r_AAT77177.1, "%s-%s" % (resn, resi)
...
show licorice, cons_606_r_AAT77177.1
    ...
    label n. CA and resi 158 and 607_i_CAI34124.1, "%s-%s" % (resn, resi)
...
cealign 606_r_AAT77177.1, 586_r_ACH50550.1
...
cealign 606_r_AAT77177.1, 608_r_CAI32772.1
